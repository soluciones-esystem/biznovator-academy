		...
		<div class="admin-dahboard-table-area">
			<div class="table-responsive">
				<table class="table table-bordered">
					<thead>
						<tr>
							<th><div class="our-course-btn"><a href="#">Our Courses</a></div></th>
							<th colspan="3"><div class="our-courses-table-title">Course Requests from Teachers</div></th>
					...
					<tbody>
						<tr class="odd-row">
							...
							<td>
								<div class="course-info-timeline">
									<div class="course-info-timeline-title">Valid Till</div>
									<div class="course-info-timeline-subtitle">December,2020</div>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="course-info-timeline">
									<div class="course-info-timeline-title">Valid Till</div>
									<div class="course-info-timeline-subtitle">January,2021</div>
								</div>
							</td>
							<td><div class="course-active-inactive-btn">
							<a href="#">ACTIVE</a>
