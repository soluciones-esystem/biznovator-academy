      ...
      <div class="row">
        <div class="col-md-4">
          <div class="manage-profile-pic-area">
              ...
              <div class="manage-profile-pic-post">School Admin</div>
        ...
        <div class="col-md-8">
          <div class="manage-profile-info">
            ...
            <div class="manage-profile-edit-btn">
              <a href="#" id="edit-btn">Edit Profile</a>
            </div>
                ...
                <div class="col-md-6 manage-profile-info-box pointer-events">
                  <label>SCHOOL ADMIN FIRST NAME</label>
                  <input type="text" name="" value="John" class="form-control">
                </div>
                <div class="col-md-6 manage-profile-info-box pointer-events">
                  <label>SCHOOL ADMIN LAST NAME</label>
                  <input type="text" name="" value="John" class="form-control">
                </div>
                <div class="col-md-6 manage-profile-info-box pointer-events">
...
<script type="text/javascript">
  ...
  $(".manage-profile-info-box ").removeClass("pointer-events");
});
</script>